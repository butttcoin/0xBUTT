...
### About the format
If code were the law, than a proper white-paper would represent a code-documentation. The code can be found deployed under Ethereum’s contract: [0x...](https://etherscan.io/address/...)
